    ...
    <Layout>
      ...
      <section className="py-12 lg:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-10">
            <h1 className="font-display font-black text-5xl lg:text-6xl text-white mb-4">ABOUT US</h1>
          ...
          <h2 className="font-display font-bold text-3xl text-white mb-5">What we stand for</h2>
          ...
          <div className="bg-primary/10 border border-primary/30 rounded-xl p-8 text-center">
            <h2 className="font-display font-black text-3xl text-white mb-3">Ready to book?</h2>
