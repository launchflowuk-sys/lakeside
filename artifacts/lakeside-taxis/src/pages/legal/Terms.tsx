    ...
    <Layout>
      ...
      <section className="py-12 lg:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="font-display font-black text-5xl text-white mb-8">TERMS & CONDITIONS</h1>
          <div className="prose prose-invert max-w-none text-foreground/80 space-y-6">
            ...
            <h2 className="font-display font-bold text-2xl text-white">1. Booking requests</h2>
            ...
            <h2 className="font-display font-bold text-2xl text-white">2. Pricing</h2>
            ...
            <h2 className="font-display font-bold text-2xl text-white">3. Cancellations</h2>
            ...
            <h2 className="font-display font-bold text-2xl text-white">4. Passenger conduct</h2>
            ...
            <h2 className="font-display font-bold text-2xl text-white">5. Delays and exceptional circumstances</h2>
            ...
            <h2 className="font-display font-bold text-2xl text-white">6. Contact</h2>
