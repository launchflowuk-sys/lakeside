    ...
    <Layout>
      ...
      <section className="py-12 lg:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="font-display font-black text-5xl text-white mb-8">COOKIE POLICY</h1>
          <div className="prose prose-invert max-w-none text-foreground/80 space-y-6">
            ...
            <h2 className="font-display font-bold text-2xl text-white">What are cookies?</h2>
            ...
            <h2 className="font-display font-bold text-2xl text-white">How we use cookies</h2>
            ...
            <h2 className="font-display font-bold text-2xl text-white">Managing cookies</h2>
            ...
            <h2 className="font-display font-bold text-2xl text-white">Contact us</h2>
